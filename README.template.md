...
> 当前版本方波有约 14.5% 的过冲，为滤波器群延时特性所致，后续将通过优化通道设计解决，详见[重构滤波器调试笔记](docs/设计笔记/重构滤波器调试笔记.md)。
...
或查看 `hardware/` 中的原理图和 PCB 设计文件与 `firmware/` 中的代码框架，了解硬件与软件的构成，并提出您的宝贵意见。
